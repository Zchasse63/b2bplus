-- ============================================================================
-- PRODUCT CATEGORIES SEED DATA (FIXED UUIDs)
-- ============================================================================
...
VALUES
  ...
  ('77777777-7777-7777-7777-77777777777a', 'Jumbo Straws', 'jumbo-straws', 'Extra-wide straws for smoothies', '77777777-7777-7777-7777-777777777777', 3, true, NOW()),
  ...
  ('88888888-8888-8888-8888-88888888888a', 'Flat Lids', 'flat-lids', 'Flat lids for hot cups', '88888888-8888-8888-8888-888888888888', 2, true, NOW()),
  
  -- Safety & Sanitation subcategories
  ('99999999-9999-9999-9999-99999999999a', 'Gloves', 'gloves', 'Disposable food service gloves', '99999999-9999-9999-9999-999999999999', 1, true, NOW()),
  ('99999999-9999-9999-9999-99999999999b', 'Masks & Face Coverings', 'masks-face-coverings', 'Protective face masks', '99999999-9999-9999-9999-999999999999', 2, true, NOW()),
  
  -- Bags & Packaging subcategories
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaab', 'Shopping Bags', 'shopping-bags', 'T-shirt and shopping bags', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 1, true, NOW()),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaac', 'Paper Bags', 'paper-bags', 'Kraft paper bags for takeout', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 2, true, NOW()),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaad', 'Food Bags', 'food-bags', 'Specialty bags for food items', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 3, true, NOW())
ON CONFLICT (id) DO NOTHING;
