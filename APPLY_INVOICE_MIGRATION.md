# Apply Invoice Migration - Manual Instructions

Since the Supabase MCP is experiencing timeouts, please apply this migration manually via the Supabase SQL Editor.
...
Supabase will show a warning about "destructive operation" (DROP TRIGGER). This is safe - we're recreating the trigger.
...
After applying, you can test by:
1. Going to the order details page for ORD-20251031-0003
2. Clicking "Generate Invoice"
3. Verifying invoice is created

---

**Note:** The migration file is also available at:
