...
import {
  ...
  renderView,
  renderViewMini,
} from '@/components/horizon/scrollbar/Scrollbar';
import { Scrollbars } from 'react-custom-scrollbars-2';
// import avatar4 from '/img/avatars/avatar4.png'; // Temporarily disabled
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              ...
              <div className={`ml-[52px] mt-[44px] flex items-center `}>
                ...
                >
                  B2B<span className="font-medium">+</span>
                </div>
                <div
                  className={`ml-1 mt-1 h-2.5 font-poppins text-[26px] font-bold uppercase text-navy-700 dark:text-white ${
                    mini === false
            ...
            <div className="mb-[30px] mt-[28px]">
              ...
              <div className="mt-5 flex items-center justify-center gap-3">
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 flex items-center justify-center text-white font-bold">
                  A
                </div>
                <div
                  className={`ml-1 ${
