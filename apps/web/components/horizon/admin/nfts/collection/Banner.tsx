import NftBanner2 from '/img/nfts/NftBanner2.png';
import NftProfile from '/img/nfts/NftProfile.png';
    ...
    <div className="flex h-full w-full flex-col items-center rounded-[20px]">
      ...
      <div className="mt-[85px] flex flex-col items-center">
        ...
        <p className="mt-[10px] flex w-full items-center justify-center text-lg font-medium text-gray-600">
          Created by{' '}
          <span className="ml-1 text-base font-bold text-[#3965FF] dark:text-white">
            simmmple.web{' '}
          </span>
          <span className="ml-1 text-[#3965FF]">
            <MdVerified />
          </span>
        </p>
      </div>
