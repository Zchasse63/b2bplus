...
import zoho from '/svg/zoho-logo.svg';
import deloite from '/svg/deloitte-logo.svg';
import georgia from '/svg/georgia-logo.svg';
import google from '/svg/google-logo.svg';
import microsoft from '/svg/microsoft-logo.svg';
import msn from '/svg/msn-logo.svg';
